...
// Arrays associativos
$pessoa = array('nome' => 'Luana', 'idade' => 22, 'altura' => 1.6);
echo $pessoa['nome'];
echo '<br>';
...
$evolucoes = array('Charmander' => array('Primeira evolução' => 'Charmeleon', 'Segunda evolução' => 'Charizard'),
                    'Squirtle' => array('Primeira evolução' => 'Wartotle', 'Segunda evolução' => 'Blastoise'),
                    'Bulbasaur' => array('Primeira evolução' => 'Ivysaur', 'Segunda evolução' => 'Venusaur')
                );
